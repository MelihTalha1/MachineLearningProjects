...
print("KF best paramter: ", tree_grid_search_kf.best_params_)
print("KF best acc: ", tree_grid_search_kf.best_score_)

# LOO
loo = LeaveOneOut()
tree_grid_search_loo = GridSearchCV(tree, tree_param_dist, cv = loo)
tree_grid_search_loo.fit(X_train, y_train)
print("LOO best paramter: ", tree_grid_search_loo.best_params_)
print("LOO best acc: ", tree_grid_search_loo.best_score_)